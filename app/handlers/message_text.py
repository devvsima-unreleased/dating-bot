...
💬 Чтобы активировать анкету, напишите команду /start.""")
    ...
    def SEARCH_SERVICES(self):
        return _("🔎 Поиск услуг начат! Мы подбираем услуги, которые могут вас заинтересовать.")

    @property
    def INVALID_SERVICE_SEARCH(self):
        return _(
            "❌ К сожалению, мы не нашли подходящих услуг. Попробуйте изменить свои предпочтения."
        )

    @property
    def EMPTY_SERVICE_SEARCH(self):
        return _("✅ Жалоба отправлена на рассмотрение!")

    @property
    def SERVICE_TYPES(self):
        return _(
            "📭 Вы просмотрели все доступные услуги. Возвращайтесь позже, чтобы увидеть новые предложения!"
        )
